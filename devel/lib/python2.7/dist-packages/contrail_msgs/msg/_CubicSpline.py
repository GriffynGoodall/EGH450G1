...
"""autogenerated by genpy from contrail_msgs/CubicSpline.msg. Do not edit."""
import sys
...
class CubicSpline(genpy.Message):
  _md5sum = "6304848616a3ce8d894ccc2d6aae12fc"
  _type = "contrail_msgs/CubicSpline"
...
string frame_id
"""
  __slots__ = ['header','start_time','duration','x','y','z','yaw']
  _slot_types = ['std_msgs/Header','time','duration','float64[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,start_time,duration,x,y,z,yaw
    ...
    """
    if args or kwds:
      super(CubicSpline, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2I2i().pack(_x.start_time.secs, _x.start_time.nsecs, _x.duration.secs, _x.duration.nsecs))
      length = len(self.x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.start_time.secs, _x.start_time.nsecs, _x.duration.secs, _x.duration.nsecs,) = _get_struct_2I2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
