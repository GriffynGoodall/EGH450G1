...
"""autogenerated by genpy from ml_msgs/MarkerDetection.msg. Do not edit."""
import sys
...
class MarkerDetection(genpy.Message):
  _md5sum = "98b2dd1b1684e7d642f181b4ca3c1f0c"
  _type = "ml_msgs/MarkerDetection"
...
"""
  ...
  _slot_types = ['std_msgs/Header','ml_msgs/Marker[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.markers:
        ...
        length = len(val1.tag_ids)
        buff.write(_struct_I.pack(length))
        pattern = '<%si'%length
        buff.write(struct.pack(pattern, *val1.tag_ids))
        length = len(val1.tag_confidence)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *val1.tag_confidence))
        _v1 = val1.pose
        _v2 = _v1.position
        _x = _v2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.tag_ids = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        val1.tag_confidence = struct.unpack(pattern, str[start:end])
        _v4 = val1.pose
        _v5 = _v4.position
        _x = _v5
        start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.markers:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%si'%length
        buff.write(val1.tag_ids.tostring())
        length = len(val1.tag_confidence)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(val1.tag_confidence.tostring())
        _v7 = val1.pose
        _v8 = _v7.position
        _x = _v8
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.tag_ids = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        val1.tag_confidence = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        _v10 = val1.pose
        _v11 = _v10.position
        _x = _v11
        start = end
